...
class MatchActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener, PlayerClickListener {
        ...
        doAsync {
            ...
            runOnUiThread {
                if (players.isNotEmpty()) {
                    ...
                    val adapter =
                        PlayerAdapter(this@MatchActivity, players, this@MatchActivity)
